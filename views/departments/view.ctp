...
<ul id="menuSession">
	...
	<li><a <?php echo $this->Html->link(sprintf(__('Listar %s', true), __('Departamentos', true)), array('action' => 'index')); ?> </a></li>
	<li><a <?php echo $this->Html->link(sprintf(__('Nuevo %s', true), __('Departamento', true)), array('action' => 'add')); ?></li>
...
<div id="formulario">
	<div id="datos">
	    	...
	    	<p class="datos-usuario"><b>Id:&nbsp;</b><?php echo $department['Department']['id']; ?> </p>
			...
			<p class="datos-usuario"><b>Facultad:&nbsp;</b><?php echo $department['Faculty']['id']; ?> </p>
		    </br>
